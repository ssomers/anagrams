...
class AnagramsSuite extends FunSuite {
  ...
  test("sentence anagrams: it") {
    val sentence = List("it")
    assert(sentenceAnagrams(sentence) === List(List("it")))
  }
  ...
  test("sentence anagrams: eat") {
    ...
    assert(sentenceAnagrams(sentence).toSet === List(List("tea"), List("eat"), List("ate")).toSet)
  }
...
class AnagramsBench extends FunSuite {
  ...
  test("sentence anagrams: grumpy cat") {
    val sentence = List("grumpy", "cat")
    assert(sentenceAnagrams(sentence).length === 164)
  }
